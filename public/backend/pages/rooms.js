...
function onPaginationDataLoad(page) {
	$.ajax({
		url:base_url + "/backend/getRoomsTableData?page="+page+"&roomtype_id="+roomtype_id,
...
function onRefreshData() {
	$.ajax({
		url:base_url + "/backend/getRoomsTableData?roomtype_id="+roomtype_id,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onSearch() {
	...
	$.ajax({
		url: base_url + "/backend/getRoomsTableData?search="+search+"&roomtype_id="+roomtype_id,
		success:function(data){
			$('#tp_datalist').html(data);
			onCheckAll();
		}
...
function onLoadEditData() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/getRoomById',
		data: 'id='+RecordId,
		success: function (response) {
			var data = response;
...
function onConfirmDelete() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/deleteRoom',
		data: 'id='+RecordId,
		success: function (response) {
			var msgType = response.msgType;
			var msg = response.msg;
...
function onConfirmBulkAction() {
    ...
    $.ajax({
		type : 'POST',
		url: base_url + '/backend/bulkActionRoom',
